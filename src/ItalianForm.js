...
function Form() {
  ...
  const handleSubmit = (e) => {
    ...
    for (let i = 0; i < formDataList.length; i++) {
      ...
      if (!isCityValid) {
        alert(
          "La città inserita non è stata trovata nell'elenco dati. Si prega di selezionare una città dall'elenco dati."
        );
        return;
      }
      ...
      if (!dobRegex.test(personData.dateOfBirth)) {
        alert("Inserisci una data di nascita valida (dd.MM.yyyy)");
        return;
      }

      const checkbox = document.getElementById("check-form");
      if (!checkbox.checked) {
        alert("Si prega di accettare il GDPR e l'informativa sulla privacy");
        return;
      }
                ...
                <div className="person-1">
                  ...
                  <div class="field-form">
                    ...
                    <select name="document-type" id="document-type">
                      ...
                      <option value="passport">Patente</option>
                      <option value="passport">Tessera sanitaria</option>
                    </select>
                  </div>
